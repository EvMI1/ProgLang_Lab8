...
**Запрос 1 — Доступные услуги, отсортированные по цене**

![Доступные услуги](screenshots/2.png)

**Запрос 2 — Услуги по типу**
...
**Запрос 4 — Самая дорогая услуга**

![Самая дорогая услуга](screenshots/8.png)

**Валидация — некорректный ввод ID**

![Валидация ID](screenshots/9.png)

**Валидация — некорректная цена и тип**
